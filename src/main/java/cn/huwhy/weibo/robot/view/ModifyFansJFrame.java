...
public class ModifyFansJFrame extends JFrame implements MouseListener {
    ...
    // 表格对象
    FansGroupDataPanel parentPanel;
    private Word word;

    private WordService wordService;

    public ModifyFansJFrame() {
        this.wordService = SpringContentUtil.getBean(WordService.class);
    }

    public void init(FansGroupDataPanel parentPanel, long id) {
